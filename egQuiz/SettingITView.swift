...
extension OtherApp {
    static let allApps = [
        OtherApp(name: "ITクエスト", description: "ゲーム感覚でITの知識が学べるアプリ。ITの基礎知識からネットワーク、データベースなど幅広く学べます。", appStoreLink: "https://apps.apple.com/us/app/it%E3%82%AF%E3%82%A8%E3%82%B9%E3%83%88/id6469339499"),
...
//                        NavigationLink(destination: StoreKitView()) {
//                            HStack {
//                                Text("課金する(開発中)")
//                                    .foregroundStyle(Color("fontGray"))
//                                Spacer()
