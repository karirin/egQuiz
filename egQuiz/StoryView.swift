...
//                )
            ...
            [
                PlatformData(
                    ...
                    padding1: EdgeInsets(top: 0, leading: 55, bottom: 0, trailing: 0)
                ),
                PlatformData(
                    imageName: self.platformImageName,
                    position: 26,
            ...
            [
                ...
                PlatformData(
                    ...
                    padding: EdgeInsets(top: 0, leading: 0, bottom: -60, trailing: 0),
                    padding1: nil,
                    paddingMonster: EdgeInsets(top: -30, leading: 0, bottom: 0, trailing: 0),
                    monster: 3
                )
            ],
            [
...
struct BossView: View {
    ...
    var body: some View {
        Image("ボス\(boss)")
            ...
            .scaledToFit()
            .shadow(radius: 10)
            .frame(width: boss == 15 ? 350 : boss == 16 ? 200 : 250)
