...
enum Rarity: Int {
    ...
    init(mode: GachaMode) {
        ...
        case .normal:
            self.items = [
                Item(name: "アンノン", attack: 10, probability: 25, health: 20, rarity: .normal),
                ...
                Item(name: "キャッチェル", attack: 20, probability: 25, health: 100, rarity: .normal),
                Item(name: "ハムハム", attack: 25, probability: 25, health: 150, rarity: .normal),
                Item(name: "ライム", attack: 30, probability: 25, health: 200, rarity: .normal),
                Item(name: "ラビン", attack: 35, probability: 10, health: 220, rarity: .rare),
                Item(name: "ラムン", attack: 40, probability: 10, health: 240, rarity: .rare),
                ...
                Item(name: "神龍 ゴッドドラゴン", attack: 50, probability: 3, health: 300, rarity: .ultraRare),
