...
struct StoyrQuizResultView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ...
        // プレビュー用にビューを初期化
        StoryQuizResultView(results: dummyResults, authManager: authManager, isPresenting: $isPresenting, navigateToQuizResultView: $navigateToQuizResultView, playerExperience: 10, playerMoney: 10, elapsedTime: 0, quizLevel: .Tango3, victoryFlag: .constant(true), isUserStoryFlag: .constant(false), viewModel: PositionViewModel.shared)
    }
}
