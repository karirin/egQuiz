...
struct StoryUserQuizListView: View {
    ...
    var body: some View {
        StoryUserQuizView(quizzes: shuffledQuizList, quizLevel: .Tango3, backgroundName: backgroundName, authManager: authManager, viewModel: viewModel, audioManager: audioManager, isPresenting: $isPresenting, interstitial: sharedInterstitial, user: user)
    }
}
